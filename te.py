...
# ============================================================
# RESPONSIVE CSS (mobile-first, header kept)
# ============================================================
st.markdown("""
<style>
...
# ============================================================
# SAFETY NET (unchanged – only for intent classification)
# ============================================================
SAFETY_PATTERNS = {
    "unauthorized_access": [
...
# ============================================================
# PROMPT BUILDER (no restrictions, general assistant)
# ============================================================
def build_prompt(query, intent, sentiment, confidence, history=None):
    # For low confidence or out-of-scope intent, we still give a generic answer
    ...
    # Keep urgent handling for safety-net intents (but still answer any question)
    urgent = ""
